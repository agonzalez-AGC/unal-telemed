...
resource "google_sql_database_instance" "med-users-db" {
  name             = "med-users-db"              # Nombre de la instancia de base de datos, asignado desde la variable
...
resource "google_sql_database" "default" {
  ...
  instance   = google_sql_database_instance.med-users-db.name  # Referencia a la instancia de Cloud SQL creada
